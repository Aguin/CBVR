...
from search_stage2 import calc_topk_min_dist
    ...
    for task_name in ['DSVR', 'CSVR', 'ISVR']:
        ...
        if results is None:
            ...
            for query_name in query_names:
                ...
                ## Stage-2
                start = time.time()
                query_result=calc_topk_min_dist(query_name, query_features, cluster_vids, cluster_features,
                                                    vid2names,10)

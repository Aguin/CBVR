...
from search_stage2 import calc_ave_min_dist, calc_topk_min_dist, calc_mean_dist
...
if __name__ == '__main__':
    ...
    # Load HNSW
    faiss_index = faiss.IndexHNSWFlat(512, 512)
    faiss_index.hnsw.efConstruction = 40
    faiss_index.add(features)
    faiss_index.hnsw.efSearch = 256
    ...
    for task_name in ['DSVR', 'CSVR', 'ISVR']:
        ...
        if results is None:
            ...
            for query_name in query_names:
                ...
                ## Stage-2
                start = time.time()
                query_result = calc_ave_min_dist(query_name, query_features, cluster_vids, cluster_features, vid2names)
